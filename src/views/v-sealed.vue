<template>
    <l-game>
        ...
        <template #button>
            <c-button v-if="this.selladoCards.length !== 0" @click="nextSobre" innerText="SIGUIENTE"></c-button>
        ...
        <template #cards>
            <div v-if="this.selladoCards.length !== 0">
                ...
                <c-cards-image :src="this.selladoCards.at(-1).Img" :alt="this.selladoCards.at(-1).CardDefId" />
                <c-cards-image :src="this.selladoCards.at(-2).Img" :alt="this.selladoCards.at(-2).CardDefId" />
                <c-cards-image :src="this.selladoCards.at(-3).Img" :alt="this.selladoCards.at(-3).CardDefId" />
                <c-cards-image :src="this.selladoCards.at(-4).Img" :alt="this.selladoCards.at(-4).CardDefId" />
                <c-cards-image :src="this.selladoCards.at(-5).Img" :alt="this.selladoCards.at(-5).CardDefId" />
                <c-cards-image :src="this.selladoCards.at(-6).Img" :alt="this.selladoCards.at(-6).CardDefId" />
            </div>
            <div v-else>
                <c-cards-image v-for="card in selladoDeck" :key="card.CardDefId" :src="card.Img" :alt="card.CardDefId"
                    :have="card.have" @click="changeColor($event)" class="notHave" />
            </div>
        </template>
    </l-game>
</template>
